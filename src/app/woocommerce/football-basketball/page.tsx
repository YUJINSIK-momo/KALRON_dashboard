...
export default function FootballBasketballWooCommercePage() {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      console.error('축구/농구 주문 데이터 조회 실패:', error)
    } finally {
      setIsLoading(false)
    }
  }
        ...
        <Card className="glass hover:shadow-xl transition-all duration-300 mb-8">
          <CardHeader>
            <div className="flex items-center space-x-2">
              ...
              <CardTitle className="text-slate-800">축구/농구 주문 상태</CardTitle>
            </div>
          ...
          <CardContent className="p-0">
            {isLoading ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-slate-600 mt-2">축구/농구 주문 데이터를 불러오는 중...</p>
              </div>
            ) : orders.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-slate-600">축구/농구 주문 데이터가 없습니다</p>
              </div>
            )}
          </CardContent>
        </Card>
