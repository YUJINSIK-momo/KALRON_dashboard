// 우커머스 API 환경 변수
const WOOCOMMERCE_STORE_URL = process.env.NEXT_PUBLIC_WOOCOMMERCE_STORE_URL || process.env.WOOCOMMERCE_STORE_URL;
const WOOCOMMERCE_CONSUMER_KEY = process.env.NEXT_PUBLIC_WOOCOMMERCE_CONSUMER_KEY || process.env.WOOCOMMERCE_CONSUMER_KEY;
const WOOCOMMERCE_CONSUMER_SECRET = process.env.NEXT_PUBLIC_WOOCOMMERCE_CONSUMER_SECRET || process.env.WOOCOMMERCE_CONSUMER_SECRET;
